    ...
    >
      <div className="space-y-3">
        <div className="flex items-start justify-between gap-2">
          <h3 className="text-sm font-semibold text-zinc-50">{project.name}</h3>
      ...
      <div className="mt-3 flex items-center justify-between text-[11px] text-zinc-400">
        ...
        <button
          type="button"
          className="rounded-full bg-sky-500/90 px-3 py-1 text-[11px] font-semibold uppercase tracking-wide text-black transition group-hover:bg-sky-400"
        >
          View details
        </button>
      </div>
